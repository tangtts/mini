    ...
    switch (sortType) {
        case SORT_TYPE.DISTANCE:
            return data.sort((a, b) => {
                return getDistance.main({ lat2: a.loc.latitude, lng2: a.loc.longitude, lat1: latitude, lng1: longitude }) - getDistance.main({ lat2: b.loc.latitude, lng2: b.loc.longitude, lat1: latitude, lng1: longitude })
            });
        case SORT_TYPE.RATE:
